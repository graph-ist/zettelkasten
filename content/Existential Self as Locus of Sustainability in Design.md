...
<iframe allow="autoplay *; encrypted-media *; fullscreen *; clipboard-write" frameborder="0" height="150" style="width:100%;overflow:hidden;border-radius:10px;background:transparent;" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-top-navigation-by-user-activation" src="https://embed.podcasts.apple.com/us/podcast/the-existential-self-and-sustainability-in-design/id1786764068?i=1000685258592&uo=4&l=en-GB&theme=auto"></iframe>
...
flowchart TD
    ...
    class Husserl,Phenomenology,Sartre,Heidegger,BeingNothingness,DAnjou,Fry,Willis,OntologicalDesign,Schon,ReflectivePractice internal-link;
```
