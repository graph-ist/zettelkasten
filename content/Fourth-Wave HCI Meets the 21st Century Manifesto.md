...
```mermaid
flowchart TD
    FuturistManifesto[Futurist Manifesto] --> DesignManifestos[Design Manifestos]
    Bannon[Bannon] --> Bodker[Bødker]
    Bodker --> ThirdWaveHCI[Third-Wave HCI]
    ThirdWaveHCI --> FourthWaveHCI[Fourth-Wave HCI]
    DunneRaby[Dunne and Raby] --> CriticalDesign[Critical Design]
    CriticalDesign --> FourthWaveHCI
    Bardzell[Bardzell] --> CriticalHCI[Critical HCI]
    CriticalHCI --> FourthWaveHCI
    Latour[Latour] --> DesignPolitics[Design and Politics]
    DesignPolitics --> FourthWaveHCI

    class FuturistManifesto,DesignManifestos,Bannon,Bodker,ThirdWaveHCI,FourthWaveHCI,DunneRaby,CriticalDesign,Bardzell,CriticalHCI,Latour,DesignPolitics internal-link;
```
