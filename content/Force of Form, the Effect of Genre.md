...
<iframe allow="autoplay *; encrypted-media *; fullscreen *; clipboard-write" frameborder="0" height="150" style="width:100%;overflow:hidden;border-radius:10px;background:transparent;" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-top-navigation-by-user-activation" src="https://embed.podcasts.apple.com/us/podcast/the-force-of-form-the-effect-of-genre/id1786764068?i=1000687751976&uo=4&l=en-GB&theme=auto"></iframe>
...
```mermaid
flowchart TD
    Sunzi --> StrategicShi[Strategic Shi]
    StrategicShi --> CalligraphyTheory[Calligraphy Theory 2nd c.]
    CalligraphyTheory --> WangXizhi[Wang Xizhi]
    CalligraphyTheory --> ZhangHuaiguan
    WangXizhi --> ChinesePainting[Chinese Painting Theory]
    GuKaizhi --> ChinesePainting
    ChinesePainting --> Shitao
    CalligraphyTheory --> LiuXie
    LiuXie --> ChineseLiteraryTheory[Chinese Literary Theory]
    Jullien --> ComparativePhilosophy[Comparative Philosophy]
    Aristotle --> WesternMimesis[Western Mimesis]
    WesternMimesis --> Jullien
    ChineseLiteraryTheory --> Jullien
    Barthes --> Jullien

    class Sunzi,WangXizhi,ZhangHuaiguan,GuKaizhi,Shitao,LiuXie,Jullien,Aristotle,Barthes internal-link;
```
