...
flowchart TD
    ...
    Hall --> Fry
    Ames --> Fry
    Leibniz --> Relationality
    Relationality --> Fry
    ChinesePhilosophy[Chinese Philosophy] --> Relationality
    Brundtland --> ESD
    ESD --> Fry

    class Heidegger,Kant,Luhmann,Noble,Hall,Ames,Leibniz,Fry,Relationality,ChinesePhilosophy,Brundtland,ESD internal-link;
```
