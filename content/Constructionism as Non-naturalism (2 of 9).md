...
flowchart TD
    ...
    Husserl --> Floridi
    Quine --> Naturalism
    Naturalism --> StrongNaturalism[Strong Naturalism]
    Floridi --> NonNaturalism[Non-Naturalism]
    Sellars --> ManifestImage[Manifest Image]
    ManifestImage --> Floridi
    Popper --> Falsificationism
    Falsificationism --> Floridi
    Lakatos --> Floridi
    McDowell --> SecondNature[Second Nature]
    Floridi --> ReversesMcDowell[Reverses McDowell]
    Moore --> NormativeNonNaturalism[Normative Non-Naturalism]
    Grice --> SemanticNonNaturalism[Semantic Non-Naturalism]

    class Kant,Husserl,Quine,Sellars,Popper,Lakatos,McDowell,Moore,Grice,Floridi internal-link;
```
