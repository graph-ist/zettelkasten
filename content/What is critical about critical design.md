...
```mermaid
flowchart TD
    Marx[Marx] --> FrankfurtSchool[Frankfurt School]
    Hegel[Hegel] --> FrankfurtSchool
    FrankfurtSchool --> Adorno[Adorno]
    FrankfurtSchool --> Horkheimer[Horkheimer]
    FrankfurtSchool --> Marcuse[Marcuse]
    Adorno --> CultureIndustry[Culture Industry Critique]
    CultureIndustry --> CriticalDesign[Critical Design]
    Gadamer[Gadamer] --> Hermeneutics[Hermeneutics]
    Hermeneutics --> CriticalDesign
    DunneRaby[Dunne and Raby] --> CriticalDesign
    CriticalDesign --> CriticalHCI[Critical HCI]

    class Marx,FrankfurtSchool,Hegel,Adorno,Horkheimer,Marcuse,CultureIndustry,CriticalDesign,Gadamer,Hermeneutics,DunneRaby,CriticalHCI internal-link;
```
