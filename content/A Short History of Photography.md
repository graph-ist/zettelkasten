...
<iframe allow="autoplay *; encrypted-media *; fullscreen *; clipboard-write" frameborder="0" height="150" style="width:100%;overflow:hidden;border-radius:10px;background:transparent;" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-top-navigation-by-user-activation" src="https://embed.podcasts.apple.com/us/podcast/a-short-history-of-photography/id1786764068?i=1000681225390&uo=4&l=en-GB&theme=auto"></iframe>
...
```mermaid
flowchart TD
    Marx[Marx] --> Benjamin[Benjamin]
    Baudelaire[Baudelaire] --> Benjamin
    Proust[Proust] --> Benjamin
    Benjamin --> AuraTheory[Aura Theory]
    Benjamin --> OpticalUnconscious[Optical Unconscious]
    Freud[Freud] --> OpticalUnconscious
    AuraTheory --> MediaTheory[Media Theory]
    AuraTheory --> VisualStudies[Visual Studies]
    Atget[Atget] --> DocumentaryPhotography[Documentary Photography]
    Sander[Sander] --> DocumentaryPhotography
    Hill[Hill] --> EarlyPhotography[Early Photography]

    class Marx,Benjamin,Baudelaire,Proust,AuraTheory,OpticalUnconscious,Freud,MediaTheory,VisualStudies,Atget,DocumentaryPhotography,Sander,Hill,EarlyPhotography internal-link;
```
