...
aliases:
  ...
  - action philosophy
reference:
  - "[Abbagnano, N., & Fornero, G. (2012). La ricerca del pensiero. Vol. 3A. Da Schopenhauer a Freud. Paravia.](https://archive.org/download/ssp-s05-e07/The%20search%20for%20thought%20-%20Unit%204%20Chapter%201.pdf)"
tags:
  - Podcast
---
...
<iframe src="https://archive.org/embed/ssp-s05-e07" width="100%" height="30" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>
...
```mermaid
flowchart TD
    Plotinus --> Maine-de-Biran
    Augustine --> Maine-de-Biran
    Descartes --> Maine-de-Biran
    Maine-de-Biran --> Bergson
    Boutroux --> Bergson
    Darwin --> Bergson
    Spencer --> Bergson
    Bergson --> Blondel
    Bergson --> Sorel
    Bergson --> Laberthonniere
    Bergson --> Proust
    Kant --> Neo-Kantianism
    Hegel --> Spiritualism

    class Plotinus,Augustine,Descartes,Maine-de-Biran,Boutroux,Darwin,Spencer,Bergson,Blondel,Sorel,Laberthonniere,Proust,Kant,Hegel,Neo-Kantianism,Spiritualism internal-link;
```
