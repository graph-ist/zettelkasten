...
flowchart TD
    ...
    Enlightenment --> Condorcet
    Voltaire --> French-Revolution
    Rousseau --> French-Revolution
    Rousseau --> Kant
    Enlightenment --> Kant

    class Descartes,Locke,Newton,Bacon,Spinoza,Bayle,Enlightenment,Voltaire,Montesquieu,Diderot,Rousseau,Condorcet,Kant,French-Revolution internal-link;
```
