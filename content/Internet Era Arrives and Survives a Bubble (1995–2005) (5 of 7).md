...
flowchart TD
    ARPANET --> NSFNET
    NSFNET --> Internet
    Usenet --> OnlineCulture[Online Culture]
    BBS --> OnlineCulture
    OnlineCulture --> SocialNetworking[Social Networking]
    Mosaic --> Web
    Web --> Bubble[Dot-com Bubble]
    Bubble --> Google
    Bubble --> Wikipedia
    Bubble --> Blogging
    Web --> DigitalLibraries[Digital Libraries]
    DigitalLibraries --> iSchools
    Jobs --> AppleDesign[Apple Design]
    Ives --> AppleDesign
    AppleDesign --> DesignTurn[Design Turn]
    Norman --> Cognittic[Cognitive Engineering]
    CognitiveEngineering --> HFES
    Card --> HPM
    HPM --> HFES
    CHI --> SIGHCI
    IS --> SIGHCI

    class Jobs,Ives,Norman,Card internal-link;
```
