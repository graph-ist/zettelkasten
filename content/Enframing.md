...
flowchart TD
    ...
    Derrida --> Mitchell
    Weber --> Mitchell
    Ibn-Khaldun --> Mitchell
    Mitchell --> Postcolonial-Studies
    Mitchell --> Critical-Theory

    class Foucault,Heidegger,Bourdieu,Derrida,Weber,Ibn-Khaldun,Mitchell,Postcolonial-Studies,Critical-Theory internal-link;
```
