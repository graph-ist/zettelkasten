...
flowchart TD
    ...
    Saussure --> Derrida
    Saussure --> Chomsky
    Lévi-Strauss --> Post-Structuralism
    Lacan --> Post-Structuralism
    Derrida --> Yale-School
    Derrida --> Deconstruction

    class Nietzsche,Heidegger,Husserl,Freud,Marx,Saussure,Lévi-Strauss,Lacan,Derrida,Foucault,Deleuze,Chomsky,Post-Structuralism,Yale-School,Deconstruction internal-link;
```
