...
```mermaid
flowchart TD
    Aristotle --> Medieval-Empiricism
    Medieval-Empiricism --> Ockham
    Ockham --> Francis-Bacon
    Francis-Bacon --> Locke
    Descartes --> Locke
    Hobbes --> Locke
    Gassendi --> Locke
    ...
    class Aristotle,Ockham,Francis-Bacon,Descartes,Hobbes,Gassendi,Newton,Locke,Berkeley,Hume,Voltaire,Montesquieu,Kant,Medieval-Empiricism internal-link;
```
...
- **Predecessors:** [[Locke]] ← influenced by ← [[Aristotle]] (anti-innatism), [[Ockham]] (nominalism), [[Francis Bacon]] (empirical method)
