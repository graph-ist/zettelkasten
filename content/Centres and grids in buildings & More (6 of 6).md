...
flowchart TD
    Gestalt --> Arnheim
    Kohler --> Arnheim
    Schopenhauer --> Arnheim
    Klee --> Arnheim
    Fuller --> Arnheim
    Arnheim --> Design-Theory
    Arnheim --> Architectural-Theory
    Nervi --> Arnheim
    Dodwell --> Arnheim
    Hoffman --> Arnheim

    class Gestalt,Kohler,Schopenhauer,Klee,Fuller,Arnheim,Design-Theory,Architectural-Theory,Nervi,Dodwell,Hoffman internal-link;
```
